...
Para parte inteira da divisão, usamos o símbolo // (duas barras) e retorna, para 7//3, o número inteiro 2 (ele trunca o resultado da divisão convencional).
Na divisão convencional, usamos o símbolo / (uma única barra) e retorna, para 7/3, o número real 2.3333333333333335.
Por fim, para resto da divisão usamos o símbolo % (porcentagem) e retorna, para 7%3, o número inteiro 1, pois, é uma divisão inexata e "sobra" 1.
'''
